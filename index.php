...
echo "<h3>TinyWebDB <a href=tags.php>Tags</a></h3>";
echo "<table border=1>";
echo "<thead><tr>";
echo "<th> Tag Name </th>";
echo "<th> Size </th>";
...
if (isset($_GET['logfile'])) {
    ...
    wp_tinywebdb_api_read_tags($logfile);
...
function wp_tinywebdb_api_read_tags($logfile)
{
    $handle      = fopen($logfile, "r");
    // make tags list
    // show tags list table
}

function wp_tinywebdb_api_read_a_tag($logfile)
{
    // read a tag
    // drow the tag iClients,Aps graph by time
}
